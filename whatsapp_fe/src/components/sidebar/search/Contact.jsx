...
function Contact({ contact, setSearchResults, socket }) {
  ...
  const openConversation = async () => {
    try {
      ...
      // Kontrol et, yeni konuşma oluşturulmuş mu
      console.log(newConvo);
        // Başarılı ise, socket üzerinden bu konuşmaya katıl
        socket.emit("join conversation", newConvo.payload._id);
      
      
        // Eğer yeni bir konuşma oluşturulamadıysa
       
      
    } catch (error) {
      console.log("Conversation opened with ID:");
      // Hata durumu
