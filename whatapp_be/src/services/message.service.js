...
export const createMessage = async (data) => {
  ...
  if (!newMessage) throw createHttpError.BadRequest("Mesaj oluşturulamadı.");
  return newMessage;
};
...
export const populateMessage = async (id) => {
  ...
  if (!msg) throw createHttpError.BadRequest("Mesaj bulunamadı.");
  return msg;
};
...
export const getConvoMessages = async (convo_id) => {
  ...
  if (!messages) {
    throw createHttpError.BadRequest("Mesajlar bulunamadı.");
  }
  return messages;
};
export const updateMessage = async (messageId, updateData) => {
    try {
      ...
      throw createHttpError.BadRequest("Mesaj güncellenirken bir sorun oluştu.");
    }
  };